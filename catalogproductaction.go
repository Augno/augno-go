...
func (r *CatalogProductActionService) BulkUpsert(ctx context.Context, body CatalogProductActionBulkUpsertParams, opts ...option.RequestOption) (res *Job, err error) {
