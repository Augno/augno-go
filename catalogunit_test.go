...
func TestCatalogUnitNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Catalog.Units.New(context.TODO(), augno.CatalogUnitNewParams{
		CreateUnitRequest: augno.CreateUnitRequestParam{
			Abbreviation:      "g",
			Name:              "Gram",
			OffsetDenominator: "1",
			OffsetNumerator:   "0",
			RatioDenominator:  "1",
			RatioNumerator:    "1",
			Type:              augno.CreateUnitRequestTypeMass,
		},
...
func TestCatalogUnitListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Catalog.Units.List(context.TODO(), augno.CatalogUnitListParams{
		Cursor:       augno.String("cursor"),
		Include:      []string{"owner"},
		Limit:        augno.Int(0),
		Q:            augno.String("q"),
		Type:         augno.CatalogUnitListParamsTypeCurrency,
