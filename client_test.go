...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Customers.Addresses.List(context.Background(), "REPLACE_ME")
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Customers.Addresses.List(context.Background(), "REPLACE_ME")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Customers.Addresses.List(cancelCtx, "REPLACE_ME")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Customers.Addresses.List(deadlineCtx, "REPLACE_ME")
		if err == nil {
