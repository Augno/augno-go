...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Healthz.Check(context.Background(), augno.HealthzCheckParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Healthz.Check(context.Background(), augno.HealthzCheckParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Healthz.Check(cancelCtx, augno.HealthzCheckParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Healthz.Check(deadlineCtx, augno.HealthzCheckParams{})
		if err == nil {
