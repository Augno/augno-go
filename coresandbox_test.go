...
func TestCoreSandboxNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Core.Sandboxes.New(context.TODO(), openmrp.CoreSandboxNewParams{
		CreateSandboxRequest: openmrp.CreateSandboxRequestParam{
			Name: "Integration Testing",
			Mode: openmrp.CreateSandboxRequestModeBlank,
		},
...
func TestCoreSandboxListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Core.Sandboxes.List(context.TODO(), openmrp.CoreSandboxListParams{
