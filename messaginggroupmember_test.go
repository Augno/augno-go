...
func TestMessagingGroupMemberNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Messaging.Groups.Members.New(
		context.TODO(),
		"cvgp_wjlypugna7s4",
		openmrp.MessagingGroupMemberNewParams{
			AddMessagingGroupMemberRequest: openmrp.AddMessagingGroupMemberRequestParam{
				MemberType:    openmrp.AddMessagingGroupMemberRequestMemberTypeUser,
				AccountUserID: openmrp.String("acus_e5zu8bde0z3h"),
...
func TestMessagingGroupMemberDelete(t *testing.T) {
	...
	_, err := client.Messaging.Groups.Members.Delete(
		context.TODO(),
		"cvgppt_obu4df48t1xx",
		openmrp.MessagingGroupMemberDeleteParams{
