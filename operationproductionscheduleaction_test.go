...
func TestOperationProductionScheduleActionQuotePromiseDate(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Operations.ProductionSchedules.Actions.QuotePromiseDate(context.TODO(), augno.OperationProductionScheduleActionQuotePromiseDateParams{
		QuotePromiseDateRequest: augno.QuotePromiseDateRequestParam{
