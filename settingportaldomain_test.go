...
func TestSettingPortalDomainNew(t *testing.T) {
	...
	_, err := client.Settings.PortalDomains.New(context.TODO(), openmrp.SettingPortalDomainNewParams{
		CreatePortalDomainRequest: openmrp.CreatePortalDomainRequestParam{
